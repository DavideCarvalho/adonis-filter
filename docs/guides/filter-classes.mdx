...
This throws `InvalidColumnFilterError` (exported from `@agora/filter`) the moment a disallowed filter or sort field is encountered. See [Validation](/docs/filter/guides/validation) for turning that into a clean HTTP response.
